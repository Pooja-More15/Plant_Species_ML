...
path1 = 'F:/Softech Solution Code/Plant Species Identification Code/dataset/3'    #path of folder of images    
path2 = 'F:/Softech Solution Code/Plant Species Identification Code/test_set/2'  #path of folder to save images    
