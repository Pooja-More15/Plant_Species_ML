...
root.title("Plant Species Identification Using Machine Learning")


#430
#++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 =Image.open('B6.jpg')
...
#
lbl = tk.Label(root, text="Plant Species Identification Using Machine Learning", font=('times', 35,' bold '), height=1, width=60,bg="maroon",fg="white")
lbl.place(x=0, y=3)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='F:/Softech Solution Code/Plant Species Identification Code/test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
