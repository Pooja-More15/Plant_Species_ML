...
#
label_l1 = tk.Label(root, text="Plant Species Identification Using Machine Learning",font=("Times New Roman", 35, 'bold'),
                    background="green", fg="white", width=60, height=1)
label_l1.place(x=0, y=3)
